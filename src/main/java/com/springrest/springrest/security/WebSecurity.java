...
public class WebSecurity {
	...
	protected SecurityFilterChain configure(HttpSecurity http) throws Exception {
		...
		http.csrf().disable().authorizeRequests()
				...
				.permitAll()
				.antMatchers(HttpMethod.POST, SecurityConstants.SIGN_UP_URL, SecurityConstants.SIGN_UP_URL + "/bulk",
						"/upload-file")
				.permitAll()
				.antMatchers(HttpMethod.PUT, SecurityConstants.SIGN_UP_URL + "/{id}").permitAll()
				.antMatchers(HttpMethod.DELETE, SecurityConstants.SIGN_UP_URL + "/{id}").permitAll()
				.anyRequest().authenticated();
